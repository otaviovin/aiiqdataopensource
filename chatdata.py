...
def initialize_qa_chain(business_id, final_answer, plan_type="free"):
    """
...
def ask_question_data(question, business_id):
    ...
    try:
        ...
        info_collection = db[f"{business_id}csv"] # Access the specific collection for the given business ID
        ...
        # === Call the QA chain with the answer and plan type ===
        qa_chain = initialize_qa_chain(business_id, final_answer, plan_type=plan_type)
        ...
        return {"answer": "Sorry, there was an error processing your question."} # Log error details if something goes wrong